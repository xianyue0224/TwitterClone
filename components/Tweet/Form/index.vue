...
<template>
  ...
  <div v-else>
    <div class="flex items-center flex-shrink-0 p-4 pb-0">
      ...
      <div class="w-full p-2">
        <textarea v-model="text"
          class="w-full h-10 text-lg text-gray-900 placeholder:text-gray-400 bg-transparent border-1 dark:text-white focus:ring-0"
    ...
    <div class="p-4 pl-16">
      ...
      <input ref="imageSelector" type="file" hidden
        accept="image/png,image/jpg,image/gif,image/ipeg"
    ...
    <div class="flex p-2 pl-14">
      ...
      <div class="ml-auto">
        <UIButton @click="handleFormSubmit" size="sm"
